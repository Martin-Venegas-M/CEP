...
df_pospol_der_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
...
df_pospol_der_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_der_1991_18 <- df_pospol_der_1991_18[-5,]
...
df_pospol_der_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
                                                                           ...
                                                                           length(which(pos_pol == "Independiente")) + 
                                                                           length(which(pos_pol == "Ninguna"))))
df_pospol_der_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_der_1995_31[nrow(df_pospol_der_1995_31)+1,] <- NA
df_pospol_der_1996_32[nrow(df_pospol_der_1996_32)+1,] <- NA
df_pospol_der_1996_33[nrow(df_pospol_der_1996_33)+1,] <- NA
...
df_pospol_der_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_der_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
#                                                                  length(which(pos_pol == "Derecha"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_der_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_der_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
#length(which(pos_pol == "Derecha"))
...
df_pospol_der_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_der_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
#                                                  length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_der_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
#                                                  length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_der_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_der_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_der = 
                                                                         length(which(pos_pol == "Derecha"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_der, file = "output/pospol/Derecha/Derecha-Edad/CEP-pospol-Derecha-Edad.RData")
#write.csv(df_pospol_der, "output/pospol/Derecha/Derecha-Edad/CEP-pospol-Derecha-Edad.csv")
write.xlsx(df_pospol_der, "output/pospol/Derecha/Derecha-Edad/CEP-pospol-Derecha-Edad.xlsx")
...
df_pospol_centder_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_centder_1991_18 <- df_pospol_centder_1991_18[-5,]
...
df_pospol_centder_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
                                                                               ...
                                                                               length(which(pos_pol == "Independiente")) + 
                                                                               length(which(pos_pol == "Ninguna"))))
df_pospol_centder_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_centder_1995_31[nrow(df_pospol_centder_1995_31)+1,] <- NA
df_pospol_centder_1996_32[nrow(df_pospol_centder_1996_32)+1,] <- NA
df_pospol_centder_1996_33[nrow(df_pospol_centder_1996_33)+1,] <- NA
...
df_pospol_centder_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
#df_pospol_centder_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
#                                                                  length(which(pos_pol == "Centro Derecha"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
#df_pospol_centder_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
#length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_centder_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
#df_pospol_centder_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
#                                                  length(which(pos_pol == "Centro Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_centder_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
#                                                  length(which(pos_pol == "Centro Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_centder_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centder_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_centder = 
                                                                             length(which(pos_pol == "Centro Derecha"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_centder, file = "output/pospol/Centro-Derecha/Centro-Derecha-Edad/CEP-pospol-Centro-Derecha-Edad.RData")
#write.csv(df_pospol_centder, "output/pospol/Centro-Derecha/Centro-Derecha-Edad/CEP-pospol-Centro-Derecha-Edad.csv")
write.xlsx(df_pospol_centder, "output/pospol/Centro-Derecha/Centro-Derecha-Edad/CEP-pospol-Centro-Derecha-Edad.xlsx")

# Centro

# 1990

df_pospol_cent_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_cent_1991_18 <- df_pospol_cent_1991_18[-5,]
...
df_pospol_cent_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
                                                                            ...
                                                                            length(which(pos_pol == "Independiente")) + 
                                                                            length(which(pos_pol == "Ninguna"))))
df_pospol_cent_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_cent_1995_31[nrow(df_pospol_cent_1995_31)+1,] <- NA
df_pospol_cent_1996_32[nrow(df_pospol_cent_1996_32)+1,] <- NA
df_pospol_cent_1996_33[nrow(df_pospol_cent_1996_33)+1,] <- NA
...
df_pospol_cent_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
#df_pospol_cent_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
#                                                                  length(which(pos_pol == "Centro"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
#df_pospol_cent_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
#length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_cent_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
#df_pospol_cent_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
#                                                  length(which(pos_pol == "Centro"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_cent_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
#                                                  length(which(pos_pol == "Centro"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_cent_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
df_pospol_cent_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_cent = 
                                                                          length(which(pos_pol == "Centro"))
                                                                        /(length(which(pos_pol == "Derecha"))+
                                                                            length(which(pos_pol == "Centro Derecha"))+
                                                                            length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_cent, file = "output/pospol/Centro/Centro-Edad/CEP-pospol-Centro-Edad.RData")
#write.csv(df_pospol_cent, "output/pospol/Centro/Centro-Edad/CEP-pospol-Centro-Edad.csv")
write.xlsx(df_pospol_cent, "output/pospol/Centro/Centro-Edad/CEP-pospol-Centro-Edad.xlsx")

# Centro Izquierda

# 1990

df_pospol_centizq_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_centizq_1991_18 <- df_pospol_centizq_1991_18[-5,]
...
df_pospol_centizq_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
                                                                               ...
                                                                               length(which(pos_pol == "Independiente")) + 
                                                                               length(which(pos_pol == "Ninguna"))))
df_pospol_centizq_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_centizq_1995_31[nrow(df_pospol_centizq_1995_31)+1,] <- NA
df_pospol_centizq_1996_32[nrow(df_pospol_centizq_1996_32)+1,] <- NA
df_pospol_centizq_1996_33[nrow(df_pospol_centizq_1996_33)+1,] <- NA
...
df_pospol_centizq_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
#df_pospol_centizq_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
#                                                                  length(which(pos_pol == "Centro Izquierda"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
#df_pospol_centizq_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
#length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_centizq_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
#df_pospol_centizq_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
#                                                  length(which(pos_pol == "Centro Izquierda"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_centizq_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
#                                                  length(which(pos_pol == "Centro Izquierda"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_centizq_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
df_pospol_centizq_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_centizq = 
                                                                             length(which(pos_pol == "Centro Izquierda"))
                                                                           /(length(which(pos_pol == "Derecha"))+
                                                                               length(which(pos_pol == "Centro Derecha"))+
                                                                               length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_centizq, file = "output/pospol/Centro-Izquierda/Centro-Izquierda-Edad/CEP-pospol-Centro-Izquierda-Edad.RData")
#write.csv(df_pospol_centizq, "output/pospol/Centro-Izquierda/Centro-Izquierda-Edad/CEP-pospol-Centro-Izquierda-Edad.csv")
write.xlsx(df_pospol_centizq, "output/pospol/Centro-Izquierda/Centro-Izquierda-Edad/CEP-pospol-Centro-Izquierda-Edad.xlsx")

# Derecha

# 1990

df_pospol_izq_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_izq_1991_18 <- df_pospol_izq_1991_18[-5,]
...
df_pospol_izq_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
                                                                           ...
                                                                           length(which(pos_pol == "Independiente")) + 
                                                                           length(which(pos_pol == "Ninguna"))))
df_pospol_izq_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_izq_1995_31[nrow(df_pospol_izq_1995_31)+1,] <- NA
df_pospol_izq_1996_32[nrow(df_pospol_izq_1996_32)+1,] <- NA
df_pospol_izq_1996_33[nrow(df_pospol_izq_1996_33)+1,] <- NA
...
df_pospol_izq_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_izq_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
#                                                                  length(which(pos_pol == "Izquierda"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_izq_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
#length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_izq_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_izq_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
#                                                  length(which(pos_pol == "Izquierda"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_izq_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
#                                                  length(which(pos_pol == "Izquierda"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_izq_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_izq_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_izq = 
                                                                         length(which(pos_pol == "Izquierda"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_izq, file = "output/pospol/Izquierda/Izquierda-Edad/CEP-pospol-Izquierda-Edad.RData")
#write.csv(df_pospol_izq, "output/pospol/Izquierda/Izquierda-Edad/CEP-pospol-Izquierda-Edad.csv")
write.xlsx(df_pospol_izq, "output/pospol/Izquierda/Izquierda-Edad/CEP-pospol-Izquierda-Edad.xlsx")

# Derecha

# 1990

df_pospol_indep_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_indep_1991_18 <- df_pospol_indep_1991_18[-5,]
...
df_pospol_indep_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
                                                                             ...
                                                                             length(which(pos_pol == "Independiente")) + 
                                                                             length(which(pos_pol == "Ninguna"))))
df_pospol_indep_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_indep_1995_31[nrow(df_pospol_indep_1995_31)+1,] <- NA
df_pospol_indep_1996_32[nrow(df_pospol_indep_1996_32)+1,] <- NA
df_pospol_indep_1996_33[nrow(df_pospol_indep_1996_33)+1,] <- NA
...
df_pospol_indep_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
#df_pospol_indep_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
#                                                                  length(which(pos_pol == "Independiente"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
#df_pospol_indep_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
#length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_indep_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
#df_pospol_indep_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
#                                                  length(which(pos_pol == "Independiente"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_indep_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
#                                                  length(which(pos_pol == "Independiente"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_indep_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
df_pospol_indep_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_indep = 
                                                                           length(which(pos_pol == "Independiente"))
                                                                         /(length(which(pos_pol == "Derecha"))+
                                                                             length(which(pos_pol == "Centro Derecha"))+
                                                                             length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_indep, file = "output/pospol/Independiente/Independiente-Edad/CEP-pospol-Independiente-Edad.RData")
#write.csv(df_pospol_indep, "output/pospol/Independiente/Independiente-Edad/CEP-pospol-Independiente-Edad.csv")
write.xlsx(df_pospol_indep, "output/pospol/Independiente/Independiente-Edad/CEP-pospol-Independiente-Edad.xlsx")

# Derecha

# 1990

df_pospol_nin_1990_14 <- df1990_14 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1990_15 <- df1990_15 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1990_16 <- df1990_16 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1991_17 <- df1991_17 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1991_18 <- df1991_18 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1991_19 <- df1991_19 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1991_20 <- df1991_20 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1992_21 <- df1992_21 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1992_22 <- df1992_22 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1992_23 <- df1992_23 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1993_24 <- df1993_24 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1993_25 <- df1993_25 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1993_28 <- df1993_28 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_nin_1991_18 <- df_pospol_nin_1991_18[-5,]
...
df_pospol_nin_1994_29 <- df1994_29 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1995_30 <- df1995_30 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
                                                                           ...
                                                                           length(which(pos_pol == "Independiente")) + 
                                                                           length(which(pos_pol == "Ninguna"))))
df_pospol_nin_1995_31 <- df1995_31 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1996_32 <- df1996_32 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1996_33 <- df1996_33 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Proms
df_pospol_nin_1995_31[nrow(df_pospol_nin_1995_31)+1,] <- NA
df_pospol_nin_1996_32[nrow(df_pospol_nin_1996_32)+1,] <- NA
df_pospol_nin_1996_33[nrow(df_pospol_nin_1996_33)+1,] <- NA
...
df_pospol_nin_1997_34 <- df1997_34 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1997_35 <- df1997_35 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1998_36 <- df1998_36 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1999_37 <- df1999_37 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_1999_38 <- df1999_38 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2000_39 <- df2000_39 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2000_40 <- df2000_40 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2001_41 <- df2001_41 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2001_42 <- df2001_42 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2002_43 <- df2002_43 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2002_44 <- df2002_44 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2003_45 <- df2003_45 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2003_46 <- df2003_46 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2004_47 <- df2004_47 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2004_48 <- df2004_48 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2005_49 <- df2005_49 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2005_50 <- df2005_50 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2005_51 <- df2005_51 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_nin_2006_52 <- df2006_52 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
#                                                                  length(which(pos_pol == "Ninguna"))
#                                                               /(length(which(pos_pol == "Derecha"))+
#                                                                  length(which(pos_pol == "Centro Derecha"))+
#                                                                 length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2006_54 <- df2006_54 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2007_55 <- df2007_55 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2007_56 <- df2007_56 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2008_57 <- df2008_57 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2008_58 <- df2008_58 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2009_59 <- df2009_59 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2009_60 <- df2009_60 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2009_61 <- df2009_61 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2010_62 <- df2010_62 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2010_63 <- df2010_63 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2011_64 <- df2011_64 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2011_65 <- df2011_65 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2012_66 <- df2012_66 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2012_67 <- df2012_67 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2012_68 <- df2012_68 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2013_69 <- df2013_69 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2013_70 <- df2013_70 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2014_71 <- df2014_71 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2014_72 <- df2014_72 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2015_73 <- df2015_73 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2015_74 <- df2015_74 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2015_75 <- df2015_75 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_nin_2016_76 <- df2016_76 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
#length(which(pos_pol == "Derecha"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_nin_2016_77 <- df2016_77 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2016_78 <- df2016_78 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
#df_pospol_nin_2017_79 <- df2017_79 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
#                                                  length(which(pos_pol == "Ninguna"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
#df_pospol_nin_2017_80 <- df2017_80 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
#                                                  length(which(pos_pol == "Ninguna"))
#                                               /(length(which(pos_pol == "Centro-Izquierda concertación"))+
#                                                  length(which(pos_pol == "Izquierda extraconcertación"))+
#                                                 length(which(pos_pol == "Ninguno"))+
...
df_pospol_nin_2017_81 <- df2017_81 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2018_82 <- df2018_82 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2019_83 <- df2019_83 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
df_pospol_nin_2019_84 <- df2019_84 %>%group_by(year, edad)%>%summarise(porc_pospol_nin = 
                                                                         length(which(pos_pol == "Ninguna"))
                                                                       /(length(which(pos_pol == "Derecha"))+
                                                                           length(which(pos_pol == "Centro Derecha"))+
                                                                           length(which(pos_pol == "Centro"))+
...
# Save database
#save(df_pospol_nin, file = "output/pospol/Ninguna/Ninguna-Edad/CEP-pospol-Ninguna-Edad.RData")
#write.csv(df_pospol_nin, "output/pospol/Ninguna/Ninguna-Edad/CEP-pospol-Ninguna-Edad.csv")
write.xlsx(df_pospol_nin, "output/pospol/Ninguna/Ninguna-Edad/CEP-pospol-Ninguna-Edad.xlsx")