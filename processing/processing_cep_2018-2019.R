...
bd2018_2019_82 <- read_sav("input/data/2018-2019/cep82octnov2018.sav")
...
bd2018_2019_84<- select(bd2018_2019_84, DS_P35, DS_P3, DS_P2_EXACTA, DS_P1, MB_P11_1:MB_P11_17, MB_P8, MB_P9)
