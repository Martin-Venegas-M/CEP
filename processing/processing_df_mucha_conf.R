  ...
  # ---- 1991b ----
  df_conf_dirpol_1991b <- df1991_18 %>%group_by(year)%>%summarise(porc_conf_dirpol= length(which(conf_dirpol== 'Mucha confianza'))
                                                                    /(length(which(conf_dirpol== 'Mucha confianza'))+
                                                                        length(which(conf_dirpol== 'Otra'))))
  ...
  df_conf_altosffaa_1991b <- df1991_18 %>%group_by(year)%>%summarise(porc_conf_altosffaa= length(which(conf_altosffaa== 'Mucha confianza'))
                                                                /(length(which(conf_altosffaa== 'Mucha confianza'))+
                                                                    length(which(conf_altosffaa== 'Otra'))))
  
  
  df_conf_diremp_1991b <- df1991_18 %>%group_by(year)%>%summarise(porc_conf_diremp= length(which(conf_diremp== 'Mucha confianza'))
                                                                    /(length(which(conf_diremp== 'Mucha confianza'))+
                                                                        length(which(conf_diremp== 'Otra'))))
  
  
  df_conf_dircortesup_1991b <- df1991_18 %>%group_by(year)%>%summarise(porc_conf_dircortesup= length(which(conf_dircortesup== 'Mucha confianza'))
                                                                      /(length(which(conf_dircortesup== 'Mucha confianza'))+
                                                                          length(which(conf_dircortesup== 'Otra'))))
  ...
  df_conf_dirpol_1992 <- df1992_23 %>%group_by(year)%>%summarise(porc_conf_dirpol= length(which(conf_dirpol== 'Mucha confianza'))
                                                                    /(length(which(conf_dirpol== 'Mucha confianza'))+
                                                                        length(which(conf_dirpol== 'Otra'))))
  ...
  df_conf_altosffaa_1992 <- df1992_23 %>%group_by(year)%>%summarise(porc_conf_altosffaa= length(which(conf_altosffaa== 'Mucha confianza'))
                                                                /(length(which(conf_altosffaa== 'Mucha confianza'))+
                                                                    length(which(conf_altosffaa== 'Otra'))))
  
  
  df_conf_diremp_1992 <- df1992_23 %>%group_by(year)%>%summarise(porc_conf_diremp= length(which(conf_diremp== 'Mucha confianza'))
                                                                    /(length(which(conf_diremp== 'Mucha confianza'))+
                                                                        length(which(conf_diremp== 'Otra'))))
  
  
  df_conf_dircortesup_1992 <- df1992_23 %>%group_by(year)%>%summarise(porc_conf_dircortesup= length(which(conf_dircortesup== 'Mucha confianza'))
                                                                      /(length(which(conf_dircortesup== 'Mucha confianza'))+
                                                                          length(which(conf_dircortesup== 'Otra'))))
